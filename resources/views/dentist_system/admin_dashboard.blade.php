...
<body>
    ...
    <div class="col-12 col-md-6 col-lg-8 col-xl-8">
        <div class="card">
            <div class="card-header">
                ...
                <a href="/see_dentist_all_appointments" class="btn btn-primary float-right">View all</a>
            </div>
                            ...
                            @forelse($upcomingAppointments as $appointment)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>{{ $appointment->dentist->Name ?? 'Unknown Dentist' }}</p>
                                    </td>
                                    <td>
                                        <h5 class="time-title p-0">Timing</h5>
                                        <p>{{ \Carbon\Carbon::parse($appointment->date)->format('d-m-Y') }}<br>
                                           {{ \Carbon\Carbon::parse($appointment->time)->format('h:i A') }}</p>
                                    </td>
                                    <td class="text-right">
                                       <p>{{ $appointment->status ?? 'Unknown Dentist' }}</p> 
                                    </td>
    ...
    <!-- If billing exists, show Billing Record button -->
    <a href="{{ route('billing.show', $appointment->billing->id) }}" class="btn btn-sm btn-success mt-2">Billing Record</a>
@else
    <!-- If no billing, show Create Billing button -->
    <a href="{{ route('billing.create', $appointment->id) }}" class="btn btn-sm btn-primary mt-2">Create Billing</a>
@endif
</td></tr>
...
<!-- Recent Dentists Card -->
<div class="col-12 col-md-6 col-lg-8 col-xl-8">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title d-inline-block">Recent Dentists</h4>
            <a href="/view_dentist_data" class="btn btn-primary float-right">See All</a>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table mb-0">
                    ...
                    <tbody>
                        @forelse($recentDentists as $dentist)
                        <tr>
                        ...
                        @empty
                        <tr><td colspan="3" class="text-center">No recent dentists.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
...
<div class="col-12 col-md-6 col-lg-8 col-xl-8 mt-4">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title d-inline-block">Recent Patients</h4>
            <a href="/all_patients_page" class="btn btn-primary float-right">See All</a>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table mb-0">
