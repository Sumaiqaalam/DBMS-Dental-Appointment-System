            ...
            <div class="content">
                <div class="row mb-4">
                    <div class="col-sm-12 d-flex justify-content-between align-items-center">
                        <h4 class="page-title" style="font-size: 28px; font-weight: 700;">List of Dentists</h4>
                        <a href="/add_new_dentist" class="btn btn-primary">+ Add New Dentist</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h5 class="card-title d-inline-block">Dentist Information</h5>
                            <div class="table-responsive mt-3">
                                <table class="table table-hover table-center mb-0 datatable">
                                    ...
                                    <tbody>
                                        @forelse($dentist_data as $dentist)
                                        <tr>
                                            <td>{{ $dentist->Name }}</td>
                                            <td>{{ $dentist->Email }}</td>
